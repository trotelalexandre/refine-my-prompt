...
export function getRefinedPrompt(
  ...
  ### Example:
  **Original Prompt:** "How to make a cake?"  
  **Guidelines:**  
  • Tone: Friendly  
  • Role: Professional Baker  
  • Format: Paragraph  
  **Refined Prompt:** "As a professional baker, provide a detailed recipe for making a chocolate cake. Please, use a friendly tone."
